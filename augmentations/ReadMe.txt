Dependencies - 
Essentia - For reading and writing audio files
...
Reference : The code written is based on the code available at https://github.com/EliosMolina/audio_degrader


All the sounds should be in the sounds folder in the same directory as the augmentations.py file. 
All the files are assumed to be sampled at 44100Hz